# LW Alliance Helper website

Source for the public site at **<https://lw-alliance-helper.github.io>**.
...
This is a plain GitHub Pages site, no build step. Hand-written HTML in the repo root, styles in `styles.css`, shared nav in `assets/nav.js`.
